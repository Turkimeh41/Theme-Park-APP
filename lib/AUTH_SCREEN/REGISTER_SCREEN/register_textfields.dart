...
import 'package:final_project/AUTH_SCREEN/Register_Screen/verifynumber_screen.dart';
                                  ...
                                  onTap: (_) async {
                                    ...
                                    if (validateAndSave()) {
                                      try {
                                        ...
                                        await UserFirebaseHandler.userExists(insRegUser.username!, insRegUser.emailAddress!, insRegUser.phonenumber!);
                                        log('User doesn\'t exists!, good.');
                                        String smsCode = await UserFirebaseHandler.sendSMSTwilio(insRegUser.phonenumber!);
